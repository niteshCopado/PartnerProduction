trigger SBQQProductOptionTrigger on SBQQ__ProductOption__c (after insert, after update, after delete, after undelete) {
  Schema.SObjectType transformToObject = kugo2p__ConfigurationOption__c.getSobjectType();
  Schema.SObjectField externalId = kugo2p__ConfigurationOption__c.ProductOptionId__c;
